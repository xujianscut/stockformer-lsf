...
from MySAC.SAC.SDAC_SAC import SAC as SAC_SDAC
import os
...
MODELS = {"maesac": SAC_MAE, "sdacsac": SAC_SDAC}

# 只为有配置的模型创建MODEL_KWARGS
MODEL_KWARGS = {}
for model_name in MODELS.keys():
    param_name = f"{model_name.upper()}_PARAMS"
    if param_name in config.__dict__:
        MODEL_KWARGS[model_name] = config.__dict__[param_name]
