...
from MySAC.SAC.meanflow_actor import MeanFlowSACPolicy
...
fix_seed = 1999
version = 'CSI/'
model_name='StockFormer_v3_meanflow/'
...
model_sac = agent.get_model("maesac", policy=MeanFlowSACPolicy, model_kwargs=MAESAC_PARAMS, tensorboard_log=tensorboard_log_dir, seed=fix_seed)
