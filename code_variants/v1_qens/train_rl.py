...
fix_seed = 1999
version = 'CSI/'
model_name='StockFormer_v1_qens/'
...
model_sac = agent.get_model("maesac",model_kwargs = MAESAC_PARAMS, policy_kwargs=POLICY_KWARGS, tensorboard_log=tensorboard_log_dir, seed=fix_seed)
