...
fix_seed = 1999
version = 'CSI/'
model_name='StockFormer_v4_flow_qens/'
...
model_sac = agent.get_model("maesac", policy=FlowSACPolicy, model_kwargs=MAESAC_PARAMS, policy_kwargs=POLICY_KWARGS, tensorboard_log=tensorboard_log_dir, seed=fix_seed)
