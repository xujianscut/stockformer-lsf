...
fix_seed = 1999
version = 'CSI/'
model_name="StockFormer_v6_flow_fusion/"
...
model_sac = agent.get_model("maesac", policy=FlowSACPolicy, model_kwargs=MAESAC_PARAMS, tensorboard_log=tensorboard_log_dir, seed=fix_seed)
